...
echo PageLayoutHelper::buildActionCard([
    [
        'url' => $baseUrl . '?new=1', 'label' => 'New ' . $tagTypeLabel . ' Tag',
        'icon' => 'circle-plus', 'class' => 'is-primary'
    ],
]);
?>
...
<form name="form1" action="#" data-search-placeholder="tags">
    <div class="box mb-4">
        ...
        <div class="level mt-4 pt-4" style="border-top: 1px solid #dbdbdb;">
            ...
            <div class="level-item">
                <?php echo PageLayoutHelper::buildPager(
...
<tr>
    ...
    <td>
        <span class="tag is-medium is-light"><?php
            echo htmlspecialchars($tag['text'] ?? '', ENT_QUOTES, 'UTF-8');
        ?></span>
    </td>
    ...
    <div class="card-content">
        <div class="level is-mobile mb-2">
            ...
            />
                ...
                <div class="level-item">
                    <span class="tag is-medium is-info is-light"><?php
                        echo htmlspecialchars($tag['text'] ?? '', ENT_QUOTES, 'UTF-8');
                    ?></span>
                </div>
            </div>
        ...
        <div class="is-flex is-flex-wrap-wrap" style="gap: 0.5rem;">
            <div class="tags has-addons mb-0">
                ...
                <?php if ($tag['usageCount'] > 0) : ?>
                <a
                    href="<?php echo $service->getItemsUrl($tag['id']); ?>"
                    class="tag is-link"
                ><?php echo $tag['usageCount']; ?></a>
                <?php else : ?>
                <span class="tag is-light">0</span>
                <?php endif; ?>
            </div>
            ...
            <div class="tags has-addons mb-0">
                ...
                <a
                    href="<?php echo $service->getArchivedItemsUrl($tag['id']); ?>"
                    class="tag is-link"
                ><?php echo $archivedCountMobile; ?></a>
                <?php else : ?>
                <span class="tag is-light">0</span>
                <?php endif; ?>
            </div>
