...
require_once 'Core/ajax_add_term_transl.php';
require_once 'Core/ajax_check_regexp.php';
require_once 'Core/ajax_chg_term_status.php';
require_once 'Core/ajax_save_impr_text.php';
require_once 'Core/ajax_save_text_position.php';
require_once 'Core/ajax_show_imported_terms.php';
