...
use Lwt\Controllers\TermTagsController;
...
require_once __DIR__ . '/../../../src/backend/Controllers/TermTagsController.php';

/**
 * Unit tests for the TermTagsController class.
 *
 * Tests the controller that extends AbstractCrudController for term tag management.
 */
class TermTagsControllerTest extends TestCase
{
    ...
    public function testControllerCanBeInstantiated(): void
    {
        ...
        $controller = new TermTagsController();

        $this->assertInstanceOf(TermTagsController::class, $controller);
    }
    ...
    public function testControllerHasCorrectPageTitle(): void
    {
        ...
        $this->assertEquals('Term Tags', $property->getValue($controller));
    }
    ...
    public function testGetIdParameterNameReturnsCorrectValue(): void
    {
        ...
        $this->assertEquals('TgID', $method->invoke($controller));
    }
}
